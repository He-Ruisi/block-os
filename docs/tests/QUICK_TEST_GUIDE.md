...
👉 **[开始响应式测试](./start-responsive-test.md)** - 新手必读，5分钟快速上手

## 测试文档索引

### 核心测试文档

- **[响应式测试矩阵](./responsive-test-matrix.md)** - 完整的设备×浏览器测试矩阵和功能清单
- **[响应式快速测试](./responsive-quick-test.md)** - 5分钟快速验证指南
- **[响应式测试检查清单](./responsive-checklist.md)** - 可打印的测试清单（推荐打印或在移动设备查看）
- **[测试报告模板](./test-report-template.md)** - 标准测试报告格式

### 自动化测试

- **[响应式测试脚本](./responsive-test-script.js)** - 浏览器控制台自动化测试脚本

### 功能测试

- **[Block 捕获调试](./block-capture-debug.md)** - Block 捕获功能调试指南

## 测试流程

```
1. 阅读 [开始响应式测试] → 了解测试准备和流程
2. 使用 [响应式快速测试] → 浏览器模拟测试（30分钟）
3. 使用 [响应式测试检查清单] → 真机测试（1小时）
4. 运行 [响应式测试脚本] → 自动化验证（5分钟）
5. 填写 [测试报告模板] → 提交测试结果（10分钟）
```
